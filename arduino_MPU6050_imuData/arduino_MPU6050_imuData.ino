...
void setup() {
  ...
  mpu.setXAccelOffset(-506.0);
  mpu.setYAccelOffset(-2990.0);
  mpu.setZAccelOffset(2820.0);
  mpu.setXGyroOffset(7.0);
  mpu.setYGyroOffset(69.0);
  mpu.setZGyroOffset(23.0);
...
void loop() {
  ...
  if (mpu.dmpGetCurrentFIFOPacket(FIFOBuffer)) { // Get the Latest packet 
    ...
    */
    ...
    // Simplified CSV output for Python parsing
    Serial.print(q.w); Serial.print(",");
    Serial.print(q.x); Serial.print(",");
    Serial.print(q.y); Serial.print(",");
    Serial.print(q.z); Serial.print(",");
    Serial.print(aaWorld.x * mpu.get_acce_resolution() * EARTH_GRAVITY_MS2); Serial.print(",");
    Serial.print(aaWorld.y * mpu.get_acce_resolution() * EARTH_GRAVITY_MS2); Serial.print(",");
    Serial.print(aaWorld.z * mpu.get_acce_resolution() * EARTH_GRAVITY_MS2); Serial.print(",");
    Serial.print(ggWorld.x * mpu.get_gyro_resolution() * DEG_TO_RAD); Serial.print(",");
    Serial.print(ggWorld.y * mpu.get_gyro_resolution() * DEG_TO_RAD); Serial.print(",");
    Serial.println(ggWorld.z * mpu.get_gyro_resolution() * DEG_TO_RAD);
